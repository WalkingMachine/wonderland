"""
Django settings for wonderland project.
...
SECRET_KEY = '3+!+41ydkfy)n$y*!s=3*!v(6ks0&oa3924w9pmpv5cml$c-9x'
...
WSGI_APPLICATION = 'wonderland.wsgi.application'
